...
bn()
{
  ...
  echo -en $gr3"# "$gr0"  █    ▐         ▀        "$gr3"||--------------------# \n"
  echo -en $gr3"# "$gr0" ▀                        "$gr3"||    "$g"version: 1.7    "$gr3"# \n"
  echo -en $gr3"################################################### "$g"\n"
}
bn1()
{
...
bn2()
{
  ...
  echo -en ""$gr0"\/_/    "$gr0"\_\/"$gr1"\/_________/"$gr2"\/_________/ "$gr3"\_\/     "$g"version: 1.7 \n\n"
...
bn3()
{
  echo -en $gr2" ██▀███   ██▓ ▒█████  ▄▄▄█████▓ \n"
  echo -en "▓██ ▒ ██▒▓██▒▒██▒  ██▒▓  ██▒ ▓▒  "$gr0"============== \n"
  echo -en $gr2"▓██ ░▄█ ▒▒██▒▒██░  ██▒▒ ▓██░ ▒░ "$gr1"| "$g"version: 1.7 "$gr1"| \n"
  echo -en $gr2"▒██▀▀█▄  ░██░▒██   ██░░ ▓██▓ ░   "$gr0"============== \n"
  echo -en $gr2"░██▓ ▒██▒░██░░ ████▓▒░  ▒██▒ ░  \n"
  echo -en "░ ▒▓ ░▒▓░░▓  ░ ▒░▒░▒░   ▒ ░░  \n"
  echo -en "  ░▒ ░ ▒░ ▒ ░  ░ ▒ ▒░     ░  \n"
